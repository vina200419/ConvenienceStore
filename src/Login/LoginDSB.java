    ...
    public LoginDSB() {
       ...
       public static boolean loginAccount(String username, String password) {
        try (Connection cn = new DBConnector().getConnection()) {
            ...
            PreparedStatement checkStmt = cn.prepareStatement("SELECT COUNT(*) FROM canuot WHERE user = ? AND pass = ? AND status = 'Active'");
      ...
      public static void showTable(DefaultTableModel table) {
        ...
        try {
            ...
            ResultSet rs = new DBConnector().getData("SELECT * FROM canuot");
